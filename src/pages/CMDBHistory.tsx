...
const mockHistory = [
  ...
  },
  {
    ...
    assetId: "AST001",
    changeType: "Location",
    oldValue: "Ruang Server - Rack 5",
    newValue: "Ruang Server - Rack 12",
    changedBy: "IT Admin",
  ...
  },
  {
    historyId: "HIS005",
    assetId: "AST001",
    changeType: "Responsible Person",
    oldValue: "Ahmad Fauzi",
    newValue: "Budi Santoso",
    changedBy: "Manager TI",
    changedAt: "2024-01-20 08:15:00",
  },
];
        ...
        <Table>
          <TableHeader>
            <TableRow style={{ backgroundColor: "#384E66" }}>
              ...
              <TableHead className="text-white font-semibold">Tipe Perubahan</TableHead>
              <TableHead className="text-white font-semibold">Nilai Lama</TableHead>
              <TableHead className="text-white font-semibold">Nilai Baru</TableHead>
              <TableHead className="text-white font-semibold">Diubah Oleh</TableHead>
              <TableHead className="text-white font-semibold">Waktu Perubahan</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
